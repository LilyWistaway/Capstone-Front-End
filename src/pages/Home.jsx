...
const moodOptions = [
  ...
  },
  {
    ...
    desc: "Active, bold, busy, high-energy",
    icon: <ElectricIcon />,
  },
  {
    value: "connection",
    title: "Connection & Shared Memories",
    desc: "Shared moments with loved ones",
    icon: <CozyIcon />,
  },
  {
    value: "exploration",
    title: "Exploration & Curiosity",
    desc: "Artistic, cultural, exploratory",
    icon: <CuriousIcon />,
  },
  {
    value: "romantic",
  ...
  {
    value: "inspiration",
    title: "Inspiration & Awe",
    desc: "Stunning, unique, bucket-list-worthy",
